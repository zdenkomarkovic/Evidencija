...
// Pronalazi aktuelni neplaćeni period kampanje i vraća njegov krajnji datum i iznos.
// Ako kampanja ima nastavke, uzima poslednji neplaćeni nastavak.
// Ako nema neplaćenih nastavaka ali osnova nije plaćena, uzima datum_isteka kampanje.
function getAktuelniPeriod(kampanja: Record<string, unknown>): { datumIsteka: Date; iznos: number } | null {
  ...
  // Pronađi poslednji neplaćeni nastavak (po datumu, opadajuće)
  ...
  // Nema neplaćenih nastavaka — proveri osnovni period
  if (!kampanja.placeno) {
    return {
